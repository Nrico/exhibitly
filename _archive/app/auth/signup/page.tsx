...
import SignUpForm from '@/components/auth/signup-form'; // Import the new client component
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="w-[550px] bg-white flex flex-col justify-center p-20 max-md:w-full max-md:p-8 overflow-y-auto">
        ...
        <SignUpForm message={searchParams?.message || ''} /> {/* Use the new component and pass message */}
      </div>
    </div>
  );
}