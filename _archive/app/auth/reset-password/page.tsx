...
import ResetPasswordForm from '@/components/auth/reset-password-form'; // Import the new client component
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="w-[550px] bg-white flex flex-col justify-center p-20 max-md:w-full max-md:p-8 overflow-y-auto">
        ...
        <ResetPasswordForm message={searchParams?.message || ''} error={searchParams?.error || ''} /> {/* Use the new component and pass message/error */}
      </div>
    </div>
  );
}