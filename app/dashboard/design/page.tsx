...
export default function SiteDesignPage() {
    const [activeTheme, setActiveTheme] = useState<Theme>('white')
    const [siteTitle, setSiteTitle] = useState('Enrico Trujillo')
        ...
        <div className="flex h-[calc(100vh-60px)] overflow-hidden -m-[50px_60px]"> {/* Negative margin to break out of dashboard padding */}
            ...
            <div className="flex-1 p-[50px_60px] overflow-y-auto bg-[#f8f9fa]">
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg p-8 mb-8">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                defaultValue="Fine Art & Digital Fabrication based in Taos, NM. Exploring the intersection of traditional saint carving and modern manufacturing."
                            />
                        </div>
                    </div>
                    ...
                    <div className="bg-white border border-[#c5a059] rounded-lg p-8 mb-8 relative overflow-hidden">
                        ...
                        <div className="bg-[#f8f9fa] p-5 rounded-md border border-dashed border-[#ccc]">
                            <div className="flex gap-2.5 mb-2.5">
                                <input
                                    type="text"
                                    defaultValue="enricotrujillo.com"
                ...
                <div className="sticky bottom-0 bg-white p-[20px_60px] border-t border-gray-200 flex justify-end gap-4 -mx-[60px] -mb-[50px]">
                    ...
                    <button className="bg-[#111111] text-white px-8 py-3 rounded-md text-sm font-medium hover:bg-[#333] transition-colors">
                        Publish Changes
                    </button>
                </div>
            </div>
